  ...
  const handleRegistration = async (e) => {
    ...
    try {
      const response = await fetch(
        `${process.env.REACT_APP_API_DOMAIN}/user/accounts/`,
        {
          method: "POST",
          headers: {
                ...
                <div className="login-area">
                  <form onSubmit={handleRegistration}>
                    ...
                    <p className="font-weight-600">
                      Nếu bạn chưa có tài khoản, hãy đăng ký ngay để trải nghiệm
                      những tiện ích tuyệt vời cùng chúng tôi.
                    </p>
                    <div className="mb-4">
                    ...
                    <div className="mb-5">
                      <small>
                        Dữ liệu cá nhân của bạn sẽ được sử dụng để cải thiện
                        trải nghiệm của bạn trên trang web này, quản lý quyền
                        truy cập vào tài khoản của bạn và cho các mục đích khác
