              ...
              <div className="dz-blog blog-single style-1">
                ...
                <div className="dz-info">
                  <div className="dz-meta  border-0 py-0 mb-2">
                    <ul className="border-0 pt-0">
                      <li className="post-date">
                        <i className="far fa-calendar fa-fw m-r10"></i>7 March,
                        2022
                      </li>
                      <li className="post-author">
                        <i className="far fa-user fa-fw m-r10"></i>By{" "}
                        <Link to={"#"}> Johne Doe</Link>
                      </li>
                    </ul>
                  </div>
                  <h4 className="dz-title">
                    The Time Is Running Out! Think About These 6 Ways To Change
                    Your Library. How To Restore Library?
                  </h4>
                  <div className="dz-post-text">
                    ...
                    <img
                      className="alignleft rounded-md w-50"
                      src={blog}
                      alt=""
                    />
                    <p>
                    ...
                    <div className="dz-blog style-1 bg-white m-b30">
                      ...
                      <div className="dz-info">
                        ...
                        <div className="dz-meta meta-bottom">
                          <ul className="">
                            <li className="post-date">
                              <i className="far fa-calendar fa-fw m-r10"></i>7
                              March, 2022
                            </li>
                            <li className="post-author">
                              <i className="far fa-user fa-fw m-r10"></i>By{" "}
                ...
                <div className="widget widget_categories">
                  ...
                  <ul>
                    <li className="cat-item cat-item-26">
                      <Link to={"/blog-list-sidebar"}>Audio</Link>(3)
                    </li>
                    <li className="cat-item cat-item-36">
                      <Link to={"/blog-list-sidebar"}>Beauty</Link>(4)
                    </li>
                    <li className="cat-item cat-item-43">
                      <Link to={"/blog-list-sidebar"}>Fashion</Link>(3)
                    </li>
                    <li className="cat-item cat-item-27">
                      <Link to={"/blog-list-sidebar"}>Images</Link>(1)
                    </li>
                    <li className="cat-item cat-item-40">
                      <Link to={"/blog-list-sidebar"}>Lifestyle</Link>(3)
                    </li>
                  </ul>
                </div>
