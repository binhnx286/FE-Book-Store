...
function ComingSoon() {
  ...
  useEffect(() => {
    ...
    // Sao chép giá trị của interval.current vào một biến cục bộ
        ...
        <div className="clearfix dez-coming-bx">
          ...
          <div className="top-right">
            <ul className="dez-social-icon">
              <li>
                <Link to={"#"} className="fab fa-facebook-f me-2"></Link>
              </li>
              <li>
                <Link to={"#"} className="fab fa-twitter me-2"></Link>
              </li>
              <li>
                <Link to={"#"} className="fab fa-linkedin-in me-2"></Link>
              </li>
              <li>
